...
import com.splitterorg.splitter.service.AusgabeService;
...
@SpringBootTest
public class AusgabeServiceTest {

  @Autowired
  GruppenService gruppeservice;
  @Autowired
  ...
  public void Test02(){
    ...
    //arrange
    Ausgabe ausgabe1 = new Ausgabe(new Benutzer("Hallo1"), List.of(new Benutzer("Hallo2"),new Benutzer("Hallo3")),"Fahrt", Money.of(40,"EUR"));
    ...
    //assert
    assertThat(gruppe1.getAusgabenliste()).contains(ausgabe1);
  }
